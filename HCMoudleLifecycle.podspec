#
#  Be sure to run `pod spec lint HCMoudleLifecycle.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "jayhe" => "email@address.com" }
  # Or just: spec.author    = "jayhe"
  # spec.authors            = { "jayhe" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/jayhe"
  ...
  spec.source_files  = "HCMoudleLifecycle/Classes/**/*.{h,m}"
